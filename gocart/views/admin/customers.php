...
<div class="top-button pull-right" style="display:none">
...
<table class="table table-striped">
	<thead>
		<tr>
			...
			<th><a href="<?php echo site_url($this->config->item('admin_folder').'/customers/index/firstname/');?>/<?php echo ($field == 'firstname')?$by:'';?>">Name
			...
			<th><a > Buiseness Name</a></th>
			<th><a > Phone</a></th>
			<th><a > Secret Code</a></th>
...
<?php foreach ($customers as $customer):?>
		<tr>
			...
			<td class="gc_cell_left"><?php echo  $customer->company; ?></td>
			<td class="gc_cell_left"><?php echo  $customer->phone; ?></td>
			<td class="gc_cell_left"><?php echo  $customer->scode; ?></td>
			<td>
