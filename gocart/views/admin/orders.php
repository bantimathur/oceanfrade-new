...
<table class="table table-striped">
    <thead>
		<tr>
			...
			<th>Ref No<?php echo sort_url('Ref No', 'order_number', $sort_by, $sort_order, $code, $this->config->item('admin_folder')); ?></th>
	...
	<tr>
		...
		<td style="white-space:nowrap"><?php echo $order->bill_firstname; ?></td>
		<td style="white-space:nowrap"><?php echo $order->ship_firstname; ?></td>
		<td style="white-space:nowrap"><?php echo date('m/d/y h:i a', strtotime($order->ordered_on)); ?></td>
		<td style="white-space:nowrap"><?php echo date('m/d/y h:i a', strtotime($order->shipped_on)); ?></td>
		<td style="span2">
