...
<div class="logo">
<img alt="Free Instant Quote" src="<?php echo $this->config->site_url()?>images/instant.jpg" />
<a href="<?php echo $this->config->site_url()?>import">
<img alt="Import" style=width:215px;height:111px;" src="<?php echo $this->config->site_url()?>images/import.jpg" /></a>
		</div>
<!--
<a href="<?php echo $this->config->site_url()?>import"><img alt="Import" style="margin-left: 65px;width:230px;height:111px;" src="<?php echo $this->config->site_url()?>images/import.jpg" /></a>
...
<!-- Modal -->
  ...
  <?php include('havequeastion.php');?>  	 
         ...
         <div class="form-date">
              ...
              <div class="label-txt">
                <div class="radio-box">
                  <input tabindex="1" type="radio" name="vOrigin" id="vOrigin" value="Toronto" checked="checked" class="getport org"/>
                  &nbsp;Toronto
                </div>
                <div class="radio-box">
                  <input tabindex="1" type="radio" name="vOrigin" id="vOrigin" value="Montreal" class="getport org" />
                  &nbsp;Montreal
                </div>
                <div class="radio-box">
                  <input tabindex="1" type="radio" name="vOrigin" id="vOrigin" value="Vancouver" class="getport org" />
                  &nbsp;Vancouver
                </div>
              </div>
              <div class="clear"></div>
            ...
            <div class="form-date">
              ...
              <div class="label-txt">
                  ...
                  <span name="city-section" id="city-section">
                     <select tabindex="3" class="last" name="vDestCity" id="vDestCity"   >
            ...
            <div class="cals-box">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr align="left">
                  <td colspan="5"><a tabindex="10" class="cals cursor" id="calculate">Calculate</a> 
&nbsp;<a class="cals cursor reset-btn" id="reset-frame1">Reset</a>
</td>
                  <span id="showaftercalculate" style="display:none">
                     ...
                     <td  class="none showafcal" align="right">
						...
						<a tabindex="11" class="cals cursor" id="email_q" style="float:right">Email Quote</a>
                     </td>
                  </span>
                </tr>
              </table>
...
<div class="clear">
				<span id="rate_notes" style="display:none;">Notes : Rate includes Port to Port Ocean Freight, Handling fee, Solas Fee, Export Declaration Fee(up to 3 lines - $1 each additional line)</span>
			 </div>
            <div class="form-date">              
             ...
             <div class="term-txt">
               ...
               <a   class="fancyboxopen" ar="<?php echo $this->config->site_url();?>quote/pageopen?id=10">Quote Notes</a> / 

			   <a  class="fancyboxopen"   ar="<?php echo $this->config->site_url();?>quote/pageopen?id=12" >Terms & Conditions</a> /

               <a title="faq" class="fancyboxopen"  ar="<?php echo $this->config->site_url();?>quote/pageopen?id=7">Faq</a> /
