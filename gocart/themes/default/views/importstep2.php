     ...
     <input type="hidden" name="order_number" id="order_number"/>
       ...
       <div class="form-row">
         <div class="form-label">
			<input name="bill_firstname" id="bill_firstname" type="text" placeholder="Shipper Name *" class="required" title="Please enter proper name">
...
<input name="ship_firstname" id="ship_firstname" type="text" placeholder="Receiver’s Name *">
       ...
       <div class="form-row">         
         ...
         <div class="clear"></div>
		  ...
		  <div  class="borderform">
			<span style="float:left;font-size: 20px;font-weight: bold;margin-bottom: 10px;">Commodity:</span>
			<span style="float:right;margin-right:60px;font-size: 20px;font-weight: bold;margin-bottom: 10px;">Additional Comments:</span>
		
       <div class="form-row">

		 <input name="tCommodity" id="tCommodity" type="text" title="Please enter commodity info"  class="required" style="vertical-align:top" placeholder="Furniture, Mugs, Toys, Auto Parts">
...
<font color="red">For Sample local pickup/delivery rates, Please </font>
               <a   class="fancyboxopen" ar="<?php echo $this->config->site_url();?>quote/pageopen?id=42">
<font color="blue">Click Here</a> 	</font>

<br>
<br>

For Door to our Warehouse/CFS rates: Please 
		<a class="herebtn cursor" id="displaypickupinfo"  name="displaypickupinfo">click here</a>
		 <br>
or 
         email us at <a href="mailto:info@shipmyfreight.ca">info@shipmyfreight.ca</a>
          <div class="clear"></div>
       </div>
          <div class="clear"></div>
       ...
       <div class="form-btn pad2">
         <input type="button" name="button" id="contactu" value="Submit & Have us contact you" class="submit-btn"><br>
<label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<font color="red">
OR
</font></label>
