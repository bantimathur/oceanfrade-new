...
class Products extends Admin_Controller {	
	...
	function form($id = false, $duplicate = false)
	{
		...
		{	
			...
			$data['salepriceindian']	= $product->salepriceindian;
		...
		$this->form_validation->set_rules('salepriceindian', 'lang:saleprice', 'trim|numeric|floatval');
		...
		*/
		...
		else
		{
			...
			$save['salepriceindian']			= $this->input->post('salepriceindian');
