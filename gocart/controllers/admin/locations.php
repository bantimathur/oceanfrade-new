...
class Locations extends Admin_Controller {	
	...
	function country_form($id = false)
	{
		...
		$this->form_validation->set_rules('shipprice', 'lang:tax', 'trim|numeric');
		...
		else
		{
			...
			$save['shipprice'] 				= $this->input->post('shipprice');
	...
	function zone_area_form($zone_id, $area_id =false)
	{
		...
		else
		{
			...
			$save['code']		= $this->input->post('code');
			$save['tax'] 		= $this->input->post('tax');
			$save['eOrigin'] 		= $this->input->post('eOrigin');
			$save['vSailingFrequency'] 		= $this->input->post('vSailingFrequency');
			$save['iTransitDays'] 		= $this->input->post('iTransitDays');
			$save['fCBMRate'] 		= $this->input->post('fCBMRate');
			$save['fMinimumCharges'] 		= $this->input->post('fMinimumCharges');
			$save['vLat'] 		= $this->input->post('vLat');
			$save['vLong'] 		= $this->input->post('vLong');
			//pr($save);exit;
