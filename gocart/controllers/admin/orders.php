...
class Orders extends Admin_Controller {	
	...
	function order($id)
	{
		...
		******************************/
		...
		//pr($data);
		//echo $data['order']->bill_country;exit;
		$consine_country = $this->location_model->get_country($data['order']->bill_country);
		$data['order']->bill_country = $consine_country->name;
		
		//echo $vDestCountry = $data['order']->vDestCountry;
		//echo $vDestCity = 	 $data['order']->vDestCity;
		//exit;
		$dest_info = $this->Order_model->getDestinationINFO($data['order']->vDestCity);
		//pr($dest_info);
		$data['dest_info'] = $dest_info;
